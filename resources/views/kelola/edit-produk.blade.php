    ...
    <form action="{{ route('produk.update', $produk->id_produk) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="kategori_produk" name="kategori_produk"
                   ...
                   value="{{ old('kategori_produk', $produk->kategori_produk) }}" placeholder="Isi kategori produk" required>
        ...
        <!-- Satuan Produk (input teks) -->
        <div class="mb-3">
            <label for="satuan_produk" class="form-label fw-semibold">Satuan Produk</label>
            <input type="text" id="satuan_produk" name="satuan_produk"
                   class="form-control @error('satuan_produk') is-invalid @enderror"
                   value="{{ old('satuan_produk', $produk->satuan_produk) }}" placeholder="Isi satuan produk" required>
            @error('satuan_produk')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea id="deskripsi_produk" name="deskripsi_produk" rows="2"
                      ...
                      placeholder="Isi deskripsi produk">{{ old('deskripsi_produk', $produk->deskripsi_produk) }}</textarea>
